...
export default function SessionControls() {
  ...
  return (
    <div className="h-screen w-screen bg-background text-on-surface font-body selection:bg-primary-fixed overflow-hidden relative">
      {/* ─── TopAppBar ─────────────────────────────────────────── */}
      <header className="bg-[#F8FAFC] font-headline font-semibold tracking-wide text-sm fixed top-0 left-0 right-0 flex justify-between items-center px-6 h-12 z-40">
        <div className="flex items-center gap-6">
          <span className="text-sm font-bold text-[#0F172A] uppercase tracking-tighter">
            Claude Code Companion
          </span>
          <nav className="hidden md:flex gap-4">
            <a className="text-[#0F172A] border-b-2 border-[#2563EB] pb-1 cursor-pointer active:opacity-70">
              Code
            </a>
            <a className="text-[#64748B] hover:text-[#2563EB] transition-colors cursor-pointer active:opacity-70">
              Terminal
            </a>
            <a className="text-[#64748B] hover:text-[#2563EB] transition-colors cursor-pointer active:opacity-70">
              History
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="ml-2 px-3 py-1 bg-surface-container-high rounded text-[#2563EB] hover:bg-surface-container-highest transition-colors">
            Settings
          </button>
        </div>
      </header>
      ...
      {/* Separator line */}
      <div className="bg-[#F1F5F9] h-[1px] w-full fixed top-12 z-40" />

      {/* ─── SideNavBar ────────────────────────────────────────── */}
      <aside className="bg-[#F1F5F9] font-body text-sm font-medium fixed left-0 top-0 h-full w-[280px] hidden md:flex flex-col p-4 gap-2 pt-16 z-30">
        {/* Project header */}
        ...
        {/* Nav items */}
        <button className="w-full text-left p-2.5 bg-[#F8FAFC] text-[#0F172A] rounded-lg relative before:content-[''] before:absolute before:left-[-8px] before:w-1 before:h-4 before:bg-[#2563EB] before:rounded-full before:top-1/2 before:-translate-y-1/2 transition-all duration-200 ease-in-out flex items-center gap-3">
          <span className="material-symbols-outlined text-[#2563EB]">add</span>
          <span>New session</span>
        </button>
        <button className="w-full text-left p-2.5 text-[#64748B] hover:bg-[#E2E8F0] rounded-lg transition-all duration-200 ease-in-out flex items-center gap-3">
          <span className="material-symbols-outlined">calendar_today</span>
          <span>Scheduled</span>
        </button>
        <button className="w-full text-left p-2.5 text-[#64748B] hover:bg-[#E2E8F0] rounded-lg transition-all duration-200 ease-in-out flex items-center gap-3" data-count={mockSessions.today.length}>
          <span className="material-symbols-outlined">history</span>
          <span>Today</span>
        </button>
        <button className="w-full text-left p-2.5 text-[#64748B] hover:bg-[#E2E8F0] rounded-lg transition-all duration-200 ease-in-out flex items-center gap-3" data-count={mockSessions.previous7Days.length}>
          <span className="material-symbols-outlined">event_note</span>
          <span>Previous 7 Days</span>
        </button>
        <button className="w-full text-left p-2.5 text-[#64748B] hover:bg-[#E2E8F0] rounded-lg transition-all duration-200 ease-in-out flex items-center gap-3" data-count={mockSessions.older.length}>
    ...
    return nil
      ...
      {/* ─── Footer / Status Bar ───────────────────────────────── */}
      <footer className="bg-[#F8FAFC] font-body text-xs tracking-tight fixed bottom-0 left-0 w-full h-8 border-t border-[#64748B]/20 flex items-center justify-between px-4 z-[60]">
        <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-4">
          <button className="text-primary font-bold hover:bg-[#F1F5F9] transition-colors px-2 py-0.5 rounded">
            {mockStatusBar.branch}
          </button>
          <button className="text-[#64748B] hover:bg-[#F1F5F9] transition-colors px-2 py-0.5 rounded">
