...
export default withMermaid(defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      themeConfig: {
        editLink: {
          pattern: 'https://github.com/abyss2021/CC-Desk/edit/main/docs/:path',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/abyss2021/CC-Desk' },
    ],
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright 2026 CC-Desk Contributors',
    },
  },
}))
